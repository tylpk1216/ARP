...
int main(int argc, char *argv[])
{
    ...
    /* Ethernet Header */
    memset(pkt.dest_mac+0, 0x10, sizeof(byte1));
    memset(pkt.dest_mac+1, 0xc3, sizeof(byte1));
    memset(pkt.dest_mac+2, 0x7b, sizeof(byte1));
    memset(pkt.dest_mac+3, 0x4c, sizeof(byte1));
    memset(pkt.dest_mac+4, 0xa3, sizeof(byte1));
    memset(pkt.dest_mac+5, 0xa4, sizeof(byte1));
    ...
    memset(pkt.target_mac+0, 0x10, sizeof(byte1));
    memset(pkt.target_mac+1, 0xc3, sizeof(byte1));
    memset(pkt.target_mac+2, 0x7b, sizeof(byte1));
    memset(pkt.target_mac+3, 0x4c, sizeof(byte1));
    memset(pkt.target_mac+4, 0xa3, sizeof(byte1));
    memset(pkt.target_mac+5, 0xa4, sizeof(byte1));
